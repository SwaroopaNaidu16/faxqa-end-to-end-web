package org.j2.faxqa.metrofax.funnel.pageobjects;
...
public class SignUpPage {
	...
	public boolean isSignUpSuccess() {
		wait.until(ExpectedConditions.elementToBeClickable(lbleFaxNumberValue));
		wait.until(ExpectedConditions.elementToBeClickable(lblPasswordValue));
	...
	public boolean isLoggedIn() {
		logger.info("Attempting to Auto log-on to new account.");
